<template>
  <div class="w-10/12 mx-auto mt-8">
    <h1 class="text-gray-800 font-hairline text-6xl">
      Declaration of Independence
    </h1>
    <p class="text-xs font-extrabold py-8 text-purple-800">
      Source:
      <a href="https://www.archives.gov/founding-docs/declaration-transcript"
        >https://www.archives.gov/founding-docs/declaration-transcript</a
      >
    </p>
    <p class="text-gray-900 text-lg tracking-wider leading-loose">
      ...
      prove this, let Facts be submitted to a candid world. He has refused his
      ...
      opposing with manly firmness his invasions on the rights of the people. He
